...
double klDivergence(double * dist1, double * dist2, std::vector<int> contextList);
double cosineSimilarity(double* dist1, double* dist2, int n);
double computeAUC(std::vector< std::pair<int, double> > rankedList, std::map<int, bool> truthValMap);
